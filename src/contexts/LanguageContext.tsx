...
const translations = {
  ...
  ku: {
    ...
    deposit: 'دپۆزی',
    withdrawal: 'بردەو',
    withdrawals: 'بردەوەکان',
    addWithdrawal: 'بردەو بەردەوە',
    withdrawalAmount: 'بردەوی بڕ',
    withdrawalDate: 'بەرواری بردەو',
    availableBalance: 'بڕی بەردەو',
    earnedSalary: 'مووچە بەردەو',
    totalWithdrawn: 'کۆی بردەو',
    startDate: 'بەرواری دەستپێکردن',
    salaryDays: 'ڕۆژانی مووچە',
    salaryPeriod: 'ماوەی مووچە',
    dailySalaryRate: 'نرخی ڕۆژانە',
